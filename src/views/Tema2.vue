  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span.texto-blanco 2
      h1 Proceso productivo

    .d-flex.flex-wrap.mb-5
      img(src="@/assets/curso/temas/tema2/img-1.png" style="max-width: 489px").col-xl-5.m-auto.mb-4
      .col-xl-7
        p(data-aos="fade-right") En la sociedad industrial la elaboración de bienes y servicios requiere un conjunto de tareas y procedimientos para llevarse a cabo dentro de una organización, indistintamente del sector a que pertenezca. Es así como el proceso productivo precisa de diversas etapas y clasificaciones para la transformación de la materia prima y la prestación de servicios en la actualidad. De esta manera
        .text-decorativo-v4.mb-3
        ...
        p(data-aos="fade-right") Dentro de las organizaciones actuales los procesos productivos están regulados por el sistema de administración de operaciones, este permite entender qué respuesta deben dar los bienes y servicios que produce la empresa como lo muestra la siguiente figura.
    ...
    .d-flex.flex-wrap.align-items-center.mb-5.p-2.p-xl-0(style="background-color: #E1EFEF;" data-aos="fade-left")
      .col-xl-7.p-3.p-xl-4.h-100.order-2.order-xl-1
        p.mb-0 Este proceso, en la realidad actual de las organizaciones, media entre la tecnología, la capacidad económica y las necesidades propias del mercado específico. Pues con las tecnologías de la comunicación las demandas del mercado son cada vez más específicas y devengan de una capacidad entre la producción y la distribución del bien o el servicio ofrecido. Por tal razón, el proceso productivo no debe tomarse a la ligera, de esto depende la calidad de los bienes y servicios ofertados, y, por ende, mantener vigente y competitiva la organización. Así, aunado al proceso productivo se encuentran las etapas de la planeación, organización, dirección y control, etapas propias del proceso administrativo interno. 
      .col-xl-5.mx-auto.mb-4.mb-xl-0.order-1.order-xl-2
        img(src="@/assets/curso/temas/tema2/img-3.jpg").d-none.d-xl-flex
        img(src="@/assets/curso/temas/tema2/img-3-1.jpg").d-flex.d-xl-none
    ...
    .bloque-texto-e.p-4.mb-5.d-flex.flex-wrap(data-aos="fade-left" style="background-color: #E1EFEF")
      .bloque-texto-e__texto.d-flex.flex-wrap.col-lg-9.order-2.order-lg-1
        .d-flex.flex-wrap.flex-xl-nowrap
          i.fas.fa-quote-left(style="color: #0E8282")
          p.mb-0.text-regular Es importante entender que las etapas del proceso productivo conllevan a establecer una serie de parámetros desde la elaboración, circulación y consumo de los bienes y/o servicios ajustados a los estándares de calidad y a la especialidad que tiene la organización para dar respuesta a la demanda del mercado. En esa medida, el proceso productivo viene de un estudio previo a la operación y a los ritmos de trabajo dentro de la organización para no tener fugas de capital, tanto económico como humano, y para esto, es importante tener en cuenta la toma de decisiones acerca de la calidad, procesos y capacidad e inventario que repercuten en el proceso productivo y están mutuamente relacionados. Por tal razón, es imperante tener en cuenta la estrategia de la organización, el análisis táctico y que estos se complementen de manera dialógica.
        p.ms-xl-5.fw-bold (Carro y González, 2012)
    ...
    .d-flex.flex-wrap.mb-5
      img.m-auto.mb-4.mb-xl-auto.col-xl-5(src="@/assets/curso/temas/tema2/img-7.jpg" style="max-width: 505px" data-aos="fade-right")
      .col-xl-7.ps-xl-4(data-aos="fade-left")
        .bloque-texto-d.color-primario.p-4.px-xl-0.bloque-edit
          .bloque-texto-d__texto.mb-2
            i.fas.fa-quote-left(style="color: #0E8282")
            p.text-regular Otro rasgo del proceso productivo es que las actividades mediante las cuales uno o varios insumos o servicios son transformados y adquieren valor agregado están condicionadas, primero, por la calidad que tiene que ver con el establecer estándares que debe cumplir el bien o servicio; segundo, por las decisiones estratégicas, las cuales se refieren a las decisiones respecto a la dirección de las operaciones de la producción, la cantidad de materia prima, la cantidad de automatización que se puede utilizar y el fomento del trabajo en equipo; y, tercero, por las decisiones de operación, estas, tienen que ver con el funcionamiento de la instalación o la prestación del servicio una vez terminado y ofrecido
            br
            br
            .h4.mb-0 (Carro y González, 2012).
            i.fas.fa-quote-right(style="color: #0E8282")
      ...
      .col-sm-6.col-xl-3.mb-4.mb-xl-0.px-2
        .tarjeta-slide.arriba.color-primario(style="background-color: #C9F0EE; min-height: 299px")
          .tarjeta-slide__contenedor
            ...
            .tarjeta-slide__img(:style="{'background-image': `url(${require('@/assets/curso/temas/tema2/tj-slide-1.jpg')})`}")
      ...
      .col-sm-6.col-xl-3.mb-4.mb-xl-0.px-2
        .tarjeta-slide.arriba.color-primario(style="background-color: #C9F0EE; min-height: 299px")
          .tarjeta-slide__contenedor
            ...
            .tarjeta-slide__img(:style="{'background-image': `url(${require('@/assets/curso/temas/tema2/tj-slide-2.jpg')})`}")
      ...
      .col-sm-6.col-xl-3.mb-4.mb-xl-0.px-sm-2
        .tarjeta-slide.arriba.color-primario(@mouseover="indicadorTarjetaSlide = false" style="background-color: #C9F0EE; min-height: 299px")
          ...
          .tarjeta-slide__contenedor
            ...
            .tarjeta-slide__img(:style="{'background-image': `url(${require('@/assets/curso/temas/tema2/tj-slide-3.jpg')})`}")
    ...
    .d-flex.flex-wrap
      ...
      img(src="@/assets/curso/temas/tema2/decorador-3.png" style="max-width: 293px").col-xl-3.m-auto.mb-4.order-1.order-xl-2
    Separador
    ...
    .titulo-segundo.color-primario
      h2#t_2_4 2.4. Gestión de los procesos
    
    .d-flex.flex-wrap.mb-5
      .col-xl-6.d-flex.align-items-center.order-2.order-xl-1(style="background-color: #E1EFEF;" data-aos="fade-right")
        p.p-4.py-xl-5 La gestión por procesos se determina como un sistema interrelacionado de procesos encaminados a acrecentar el bienestar del cliente, ya que aleja los obstáculos entre las diferentes áreas funcionales, de tal modo que ahonda los esfuerzos en alcanzar las metas de la organización
      img.mb-0.col-xl-6.order-1.order-xl-2.d-none.d-xl-flex(src="@/assets/curso/temas/tema2/img-10.jpg" data-aos="fade-left")
      img.mb-4.order-1.order-xl-2.d-flex.d-xl-none(src="@/assets/curso/temas/tema2/img-10-1.jpg" data-aos="fade-left")

    p.mb-5(data-aos="fade-right") Además, se encarga de organizar y gestionar las actividades que crean valor en la empresa. Por lo tanto, involucra:
    ...
    SlyderA.p-4.p-lg-4.slider-v3.mb-5(tipo="b" data-aos="fade-left" :style="{'background-image': `url(${require('@/assets/curso/temas/tema2/bg-slider.svg')})`}")
      ...
      .d-flex.flex-wrap.px-2.px-lg-5
        p.w-100.ps-lg-4 #[b Supervisión y mejora] del cumplimento de las obligaciones y objetivos de los procesos.
        img(src="@/assets/curso/temas/tema2/slide-3.svg" style="max-width: 541px").mx-auto

      .d-flex.flex-wrap.px-2.px-lg-5
        p.w-100.ps-lg-4 #[b Identificación de los principales procesos], representa los procesos mediante la implementación de diagramas de flujo.
        img(src="@/assets/curso/temas/tema2/slide-4.svg" style="max-width: 1030px").mx-auto

      .d-flex.flex-wrap.px-2.px-lg-5
        p.w-100.ps-lg-4 #[b Proyección y rediseño] de los principales procesos.
        img(src="@/assets/curso/temas/tema2/slide-5.svg" style="max-width: 553px").mx-auto

      .d-flex.flex-wrap.px-2.px-lg-5
        p.w-100.ps-lg-4 #[b Gestionar la calidad del proceso] (control, mejora y planificación de la calidad).
        img(src="@/assets/curso/temas/tema2/slide-6.svg" style="max-width: 411px").mx-auto
        
      .d-flex.flex-wrap.px-2.px-lg-5
        p.w-100.ps-lg-4 #[b Implementación de indicadores] como mecanismo de evaluación de la eficacia y eficiencia de los procesos.
        img(src="@/assets/curso/temas/tema2/slide-7.svg" style="max-width: 653px").mx-auto
        
      .d-flex.flex-wrap.px-2.px-lg-5
        p.w-100.ps-lg-4 #[b Auditoría de los procesos], por ello es necesario documentarlos.
        img(src="@/assets/curso/temas/tema2/slide-8.svg" style="max-width: 719px").mx-auto
</template>
