...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5
      img(src="@/assets/curso/temas/tema1/img-1.png" data-aos="fade-right" style="max-width: 505px").col-12.col-lg-6.m-auto.mb-4.m-lg-auto
    ...
    p.mb-5.fw-bold Ampliando el concepto
