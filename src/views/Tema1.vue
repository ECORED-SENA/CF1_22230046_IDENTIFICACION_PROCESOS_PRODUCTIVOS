...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5
      img.col-12.col-lg-6.mb-4.mb-lg-0(src="@/assets/curso/temas/tema1/img-1.jpg" data-aos="fade-right" style="max-width: 558px")
      .col-12.col-lg-6.ps-lg-4(data-aos="fade-left")
    ...
    .col-xl-10.mx-auto(data-aos="fade-right")
      ...
      .bloque-texto-f.color-secundario.pt-4.px-5.mb-5.edit-cajon-v1(data-aos="fade-left")
    ...
    AcordionA.mb-5.acordeon-edit-v1(tipo="a" clase-tarjeta="tarjeta tarjeta--azul" data-aos="fade-left")
      .row.col-lg-11.mx-auto.align-items-center(titulo="Las funciones básicas")
        .col-md-5.me-auto.mb-4.mb-md-0
          p Se relacionan con los temas organizacionales, sin importar el tipo y tamaño (personal y presupuesto) de la organización permitiendo lograr objetivos, por ejemplo, ventas, producción, prestaciones, entre otras.
        .col-md-6
          figure
            img(src='@/assets/curso/temas/tema1/acordeon-1.svg' style="max-width: 482px")
      
      .row.col-lg-11.mx-auto.align-items-center(titulo="Las funciones de apoyo")
        .col-md-5.me-auto.mb-4.mb-md-0
          p Son fundamentales y complementarias de las básicas, ya que apoyan el cumplimiento de la misión organizacional como clave para el suministro de recursos necesarios para el desarrollo de la actividad de la organización; por ejemplo, gestión de los recursos humano, financiero, organizacional y sistemático, y de administración. 
        .col-md-6
          figure
            img.ms-auto(src='@/assets/curso/temas/tema1/acordeon-2.svg' style="max-width: 403px")
